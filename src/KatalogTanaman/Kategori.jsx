import { Link } from 'react-router-dom'; // Tambahkan Link dari React Router
        ...
        <div className="container mx-auto py-10">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                {categories.map((category) => (
                    <Link to={`/kategori/${category.id}`} key={category.id} className="bg-transparent border border-gray-300 rounded-lg shadow-md overflow-hidden">
