...
const conditionsData = {
  1: {
    ...
    description:
      "Kami ingin membantu anda menemukan solusi alami dalam mengatasi berbagai masalah pernapasan seperti batuk, asma, flu, sesak napas, dan bronkitis.",
    image: pernapasan,
    conditions: [
  ...
  2: {
    ...
    description:
      "Temukan ramuan herbal yang membantu mengatasi masalah pencernaan seperti maag, diare, sembelit, dan lainnya.",
    image: pencernaan,
    conditions: [
      { id: 1, name: "Maag", image: "https://placehold.co/200x300?text=Maag" },
      {
        id: 2,
        name: "Diare",
        image: "https://placehold.co/200x300?text=Diare",
      },
      {
        id: 3,
        name: "Sembelit",
        image: "https://placehold.co/200x300?text=Sembelit",
      },
    ...
    conditions: [
      {
        id: 1,
        name: "Jerawat",
        image: "https://placehold.co/200x300?text=Maag",
      },
      {
        id: 2,
        name: "Kudis",
      ...
      },
      {
        id: 4,
        name: "Biduran",
        image: "https://placehold.co/200x300?text=Mual",
      },
    ],
  },
  4: {
  ...
  6: {
    ...
    conditions: [
      {
        id: 1,
        name: "Sindrom Ovarium Polikistik",
        image: "https://placehold.co/200x300?text=Maag",
      },
      {
        id: 2,
        name: "Amenorea (Tidak Menstruasi)",
        image: "https://placehold.co/200x300?text=Diare",
      },
      {
        id: 3,
        name: "Disfungsi Ereksi (Impotensi)",
        image: "https://placehold.co/200x300?text=Sembelit",
      },
      {
        id: 4,
        name: "Nyeri Menstruasi (Dismenorea)",
        image: "https://placehold.co/200x300?text=Mual",
      },
    ],
  },
  ...
  8: {
    ...
    conditions: [
      ...
      {
        id: 4,
        name: "Depresi Ringan dan Kecemasan",
        image: "https://placehold.co/200x300?text=Mual",
      },
    ],
  },
  ...
  return (
    <>
      ...
      <div className="mt-8 text-center">
        <a
          href="/resep-ramuan"
          className="text-green-600 flex items-center pl-28 pb-10"
        >
